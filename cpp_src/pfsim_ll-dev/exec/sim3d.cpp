...
int main() {
	...
	const char outdirname[128] = "/tmp/pfsim_mimqob_w/";
	...
	char infilename[128] = "/tmp/pfsim_mimqob_w/map.ops";
	...
	CHECK_FILE_READ(sim::readcoeffmaps, "/tmp/pfsim_mimqob_w/L.txt", coeffmapsbuffer.data, inccoeff);
	// now repeat for gamma
	CHECK_FILE_READ(sim::readcoeffmaps, "/tmp/pfsim_mimqob_w/gamma.txt", coeffmapsbuffer.data+1, inccoeff);
