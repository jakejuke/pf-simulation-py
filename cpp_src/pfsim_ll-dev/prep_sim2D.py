# Prepare everything to run a 2D simulation
# Originally written for JP's Bachelor thesis and modified for Leonard's
...
def prep_sim(h5f: str):
    ...
    num_iter = sim_pars['sim_steps']
    step_size = sim_pars['save_interval']
    ...
    patterns_cpp = {
        ...
        #r'char infilename': f"\tchar infilename[50] = \"{os.path.splitext(ops)[0]}\";"
    }
    ...
    # Updates to config2d.hpp
    # There are many more parameters set in the config2d.hpp file, but I
