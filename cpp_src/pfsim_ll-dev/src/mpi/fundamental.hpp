#ifndef SRC_MPI_FUNDAMENTAL_HPP
#define SRC_MPI_FUNDAMENTAL_HPP 1
...
/*    Credits: A.F.Borchert, provided in the
   ...
   this file provides functions that return the
   fundamental MPI datatypes
   example:
   int a;
   get_type(a) -> will return MPI_INT
*/
