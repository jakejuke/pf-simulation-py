#ifndef SRC_SIM_GETGAMMACOEFF_SINGLEGRAINWETS_HPP
#define SRC_SIM_GETGAMMACOEFF_SINGLEGRAINWETS_HPP
...
T get_Gammacoeff_singleGrainWets(std::size_t n,
	...
	for (std::size_t l=0; l<n; ++l) {
        ...
        if(ida == ABNORMAL_GRAIN || idb == ABNORMAL_GRAIN){
            qsum += GAMMA_SINGLE_GRAIN*valbuf[l*incValbuf]*valbuf[l*incValbuf];
        }else{
