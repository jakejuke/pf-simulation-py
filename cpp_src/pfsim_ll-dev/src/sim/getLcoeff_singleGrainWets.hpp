#ifndef SRC_SIM_GETLCOEFF_SINGLEGRAINWETS_HPP
#define SRC_SIM_GETLCOEFF_SINGLEGRAINWETS_HPP 1
...
T get_Lcoeff_singleGrainWets(std::size_t n,
			 T* misorientation,
	...
	for (std::size_t l=0; l<n; ++l) {
		for (std::size_t nl=l+1; nl<n; ++nl) {
			...
			if(ida == ABNORMAL_GRAIN || idb == ABNORMAL_GRAIN) {
                ...
                Lcoeff += opproduct*L_SINGLE_GRAIN;
