#ifndef SRC_SIM_STEPISO3D_HPP
#define SRC_SIM_STEPISO3D_HPP 1
...
int stepiso(std::size_t m, std::size_t n, std::size_t k,
			std::size_t maxnop,
...
//wrapper function
template <typename T, typename S, typename R>
int stepiso(mesh::thd::Mesh3d<S> &orignop, 
		...
		return sim::thd::stepiso(orignop.xsize(), orignop.ysize(), orignop.zsize(),
						origval.opbufsize(),
