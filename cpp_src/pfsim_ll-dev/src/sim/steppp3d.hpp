#ifndef SRC_SIM_STEPPP3D_HPP
#define SRC_SIM_STEPPP3D_HPP 1
...
int steppp(std::size_t m, std::size_t n, std::size_t k,
			std::size_t maxnop,
...
//wrapper function
template <typename T, typename S, typename R>
int steppp(mesh::thd::Mesh3d<S> &orignop, 
		...
		return sim::thd::steppp(orignop.xsize(), orignop.ysize(), orignop.zsize(),
						origval.opbufsize(),
