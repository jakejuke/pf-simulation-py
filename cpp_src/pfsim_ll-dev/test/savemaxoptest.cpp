...
#include <src/mesh/maxop.hpp>
#include <src/mesh/storemesh.hpp>
#include <cstdio>
#include <cstddef>
...
int main() {
	...
	mesh::twd::Mesh2d<unsigned short> mu(4,4);

	// run subroutine
	mesh::twd::maxop(nop, m, id, l, mu);
	...
	char outputfilename[32] = "./maxop.out";
	int returnmessage = mesh::twd::storemesh(outputfilename,l,mu);
